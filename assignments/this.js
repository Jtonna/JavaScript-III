...
// Window binding is like the forest of trees, not sure which one we are pointing at, so we point at the forest.

* 2. Implicit Binding

// Implicit Binding is (Automatic) with objects and methods

* 3. New Binding

// New Binding is when you want to simply bind something new to something that already exists.

* 4. Explicit Binding

// explict binding is when you want to specifically bind a variable to a function (very descriptive)
